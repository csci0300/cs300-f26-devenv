...
for i in addr2line c++filt cpp-15 g++-15 gcc-15 gcov-15 gcov-dump-15 gcov-tool-15 size strings; do \
    ln -s /usr/bin/x86_64-linux-gnu-$i /usr/x86_64-linux-gnu/bin/$i; done && \
    ln -s /usr/bin/x86_64-linux-gnu-cpp-15 /usr/x86_64-linux-gnu/bin/cpp && \
    ln -s /usr/bin/x86_64-linux-gnu-g++-15 /usr/x86_64-linux-gnu/bin/c++ && \
    ln -s /usr/bin/x86_64-linux-gnu-g++-15 /usr/x86_64-linux-gnu/bin/g++ && \
    ln -s /usr/bin/x86_64-linux-gnu-gcc-15 /usr/x86_64-linux-gnu/bin/gcc && \
    ln -s /usr/bin/x86_64-linux-gnu-gcc-15 /usr/x86_64-linux-gnu/bin/cc && \
